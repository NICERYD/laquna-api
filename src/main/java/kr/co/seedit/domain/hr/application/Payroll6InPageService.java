...
//		header.setLeft(StringUtils.getNumberString(reportParamsDto.getYyyymm().substring(4,6)) +"월 급여");
    ...
    public static void setValuePayrollTableForm(XSSFSheet sheet, Payroll6InPageDto data, int no, int curRow, int curCol,
        ...
        if (null != data.getKoreanName()) {
            if ("".equals(data.getHireDiv())) {
                ...
                sheet.getRow(curRow + 0).getCell(curCol + 3).setCellStyle(retireHivediv);
            } else if ("NEW".equals(data.getHireDiv())) {
                sheet.getRow(curRow + 0).getCell(curCol + 3).setCellStyle(newHivediv);
            }
        ...
        //식대
        if (0 != data.getAttribute12() && null != data.getMeal()) {
    ...
    public static void setSumPayrollTable(XSSFSheet sheet, Payroll6InPageDto data, int startRow, int startCol) {
        int curRow = startRow;
        int curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("NO.");
        curCol++;
        curCol++;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getSalaryAmt());
        curRow++;
        curCol = startCol;
        curCol++;
        curCol++;
        curCol++;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getSalaryAmt2());
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("기본급");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getTotalTime());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getBasicAmount());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연장1");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연봉/시급");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOvertimeDaytime01());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOvertimeAllowance01());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연장2");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연봉/포괄");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOvertimeDaytime02());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOvertimeAllowance02());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("야간수당");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("주간(시급)");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtDaytime01());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtDayAllowance01());
        curCol++;
        curRow++;
        curCol = startCol;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("야간(연봉/시급)");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtNighttime01());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtNightAllowance01());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("야간2");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연봉/포괄");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtNighttime02());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getNtNightAllowance02());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("휴일1");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("토요(연봉/시급)");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidaySatTime01());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidaySatAllowance01());
        curCol++;
        curRow++;
        curCol = startCol;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("일요(연봉/시급)");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidaySunTime01());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidaySunAllowance01());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("휴일2");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연봉/포괄");
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidayTime02());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHolidayAllowance02());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연차사용");
        curCol++;
        curCol++; // sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAnnualLeaveUsed());
        curCol++;
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연차수당");
        curCol++;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute01());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("연차정산");
        curCol++;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute23());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("반차");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getHalfLeaveUsed());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute15());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("조퇴");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getEarlyLeaveTime());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute13());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("지각");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getLateTime());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute14());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("외출");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOuterTime());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute17());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("초과수당");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getOther02Used());
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute16());
        curCol++;
        curRow++;
        curCol = startCol;
        curCol++;
        ...
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("보조금");
        sheet.getRow(curRow).getCell(curCol++).setCellValue("교통비");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute11());
        curCol++;
        curRow++;
        curCol = startCol;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("식대");
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getAttribute12());
        curCol++;
        curRow++;
        curCol = startCol;
        sheet.getRow(curRow).getCell(curCol++).setCellValue("합 계");
        curCol++;
        curCol++;
        sheet.getRow(curRow).getCell(curCol++).setCellValue(data.getTotalAmt());
        curCol++;
